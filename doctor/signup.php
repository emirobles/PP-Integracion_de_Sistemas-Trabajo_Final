...
echo "<script>alert('Hubo un error, por favor intente nuevamente');</script>";
}
}
 else
{

echo "<script>alert('Email-id ya registrado. Intente de vuelta');</script>";
}
}
...
<body class="simple-page">
	...
	<div class="simple-page-wrap">
		<div class="simple-page-logo animated swing">
				...
				<span style="color: white">YDHP</span>
			
		</div><!-- logo -->
		<div class="simple-page-form animated flipInY" id="login-form">
	<h4 class="form-title m-b-xl text-center">Sign Up With Your YDHP Account</h4>
