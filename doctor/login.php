...
<head>
	...
	<title>YDHP - Inicia sesión</title>
...
<body class="simple-page">
	...
	<div class="simple-page-wrap">
		<div class="simple-page-logo animated swing">
				...
				<span style="color: white">ARPSI</span>
			
		</div><!-- logo -->
		<div class="simple-page-form animated flipInY" id="login-form">
	<h4 class="form-title m-b-xl text-center">Inicia sesión con su cuenta ARPSI</h4>
...
<div class="simple-page-footer">
	<p><a href="forgot-password.php">OLVIDASTE TU CLAVE?</a></p>
